...
class Lite6Gripper:
    ...
    def open(self):
        self._arm.set_gripper_position(GRIPPER_OPEN_MAX)

    def close(self):
        self._arm.set_gripper_position(GRIPPER_OPEN_MIN)
    ...
    def set_gripper_state(self, gripper_state: float) -> None:
        ...
        if gripper_state is not None:
            if (
                ...
                or self._prev_gripper_state != gripper_state
            ):
...
class XarmEndEffector(Robot):
    ...
    def __init__(self, config: XarmEndEffectorConfig):
        ...
        self._jacobi = JacobiRobot(
            os.path.join(this_dir, "/home/zekaijin/lerobot-hilserl-ufactory/simulation/Lite6/lite6.urdf"), ee_link="link_eef"
        )
