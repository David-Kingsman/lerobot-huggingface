...
from lerobot.common.robots.xarm.config_xarm import Xarm6EndEffectorConfig
...
class Robotiq2F85Gripper:
    def __init__(self, arm: XArmAPI):
        self._arm = arm
        self._gripper_state = 1  # Initialize to open state 
    ...
    def reset_gripper(self) -> None:
        ...
        self._gripper_state = 1.0  # Reset to open state

class Xarm6EndEffector(Robot):
    config_class = Xarm6EndEffectorConfig
    name = "xarm6_end_effector"

    def __init__(self, config: Xarm6EndEffectorConfig):
        ...
        self._jacobi = JacobiRobot(
            os.path.join(this_dir, "/home/zekaijin/lerobot-hilserl-ufactory/simulation/xarm6/xarm6_robotiq.urdf"), ee_link="eef"
        )
